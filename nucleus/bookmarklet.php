...
// find out what to do
switch ($action) {
    case 'additem': bm_doAddItem();
        break; // adds the item for real
    case 'edit': bm_doEditForm();
        break; // shows the edit item form
    case 'edititem': bm_doEditItem();
        break; // edits the item for real
    case 'delete': bm_doDeleteItem();
        break;
    case 'itemdeleteconfirm': bm_doDeleteItemComplete();
        break;
    ...
    case 'add': default: bm_doShowForm();
        break;
}
