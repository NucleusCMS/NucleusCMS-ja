...
class NAVLIST extends ENCAPSULATE
{
    ...
    public function showNavigation()
    {
        ...
        if($amount < $this->total) {
            $page_navigation = sprintf('<span style="margin-left:1em;">page %d / %d (%d - %d / %d)</span>', $current_page, $total_pages, $start + 1, (is_null($this->total) ? $start + $amount : min($start + $amount, $this->total)), $this->total);
